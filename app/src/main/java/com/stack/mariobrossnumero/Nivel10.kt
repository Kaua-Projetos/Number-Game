...
import com.stack.mariobrossnumero.databinding.ActivityNivel10Binding
import java.util.Random

class Nivel10 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel10Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel10Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(101)
