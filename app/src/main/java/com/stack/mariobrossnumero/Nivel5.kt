...
import com.stack.mariobrossnumero.databinding.ActivityNivel5Binding
import java.util.Random

class Nivel5 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel5Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(51)
