...
import com.stack.mariobrossnumero.databinding.ActivityNivel8Binding
import java.util.Random

class Nivel8 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel8Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(81)
        ...
        binding.btNext.setOnClickListener { view ->
            val intent = Intent(this, Nivel9::class.java)
