...
import com.stack.mariobrossnumero.databinding.ActivityNivel3Binding
import java.util.Random

class NIvel3 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel3Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(31)
