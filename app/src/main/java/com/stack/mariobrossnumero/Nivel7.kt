...
import com.stack.mariobrossnumero.databinding.ActivityNivel7Binding
import java.util.Random

class Nivel7 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel7Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(71)
        ...
        binding.btNext.setOnClickListener { view ->
            val intent = Intent(this, Nivel8::class.java)
