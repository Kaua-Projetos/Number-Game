...
import com.stack.mariobrossnumero.databinding.ActivityNivel4Binding
import java.util.Random

class Nivel4 : AppCompatActivity() {
    private lateinit var binding : ActivityNivel4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNivel4Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btNext.visibility = View.GONE

        window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN

        numberRandom = Random().nextInt(41)
